...
### 🛠️ Tech Stack Used
* **Frontend:** HTML5, CSS3 (Modern Flexbox layout, smooth transitions)
* **Logic Engine:** Vanilla JavaScript (DOM manipulation, event filtering, asynchronous delays)

---

## 🚀 How to Run the Project Locally

To test the platform directly on your machine, follow these quick steps:

1. **Clone or Download the Repository:**
   ```bash
   git clone [https://github.com/YOUR_GITHUB_USERNAME/CodeAlpha_Chatbot_Website.git](https://github.com/YOUR_GITHUB_USERNAME/CodeAlpha_Chatbot_Website.git)
